...
# Mock classes for EpisodeData and EntityEdgeSourceTarget
class EpisodeData:
...
class GraphBuilderService:
    ...
    def set_ontology(self, graph_id: str, ontology: Dict[str, Any]):
        """设置图谱本体（公开方法）"""
        pass
        # Mute this for local usage since we just pass dicts now
        ...
        # We just store the ontology as dict in local mock
